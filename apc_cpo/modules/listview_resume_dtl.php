...
$page_title       = 'ListView: Resume Dtl';
$db_subclass      = 'resume_dtl';
$html_subclass    = 'resume_dtl_html';
$arr_pkey_name    = array('id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add resume dtl';
$edit_link        = 'Edit resume dtl';
$delete_link      = 'Delete resume dtl';
$view_link        = 'View resume dtl';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_resume_dtl.php';
$edit_page        = 'edit_resume_dtl.php';
$delete_page      = 'delete_resume_dtl.php';
$view_page        = 'detailview_resume_dtl.php';
$csv_page         = 'csv_resume_dtl.php';
$report_page      = 'reporter_resume_dtl.php';
