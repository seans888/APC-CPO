...
class html
{
    ...
    function draw_max_file_size($max_file_size)
    {
    ...
    function draw_file_upload($cobalt_text_field_label, $tf_control_name='', $upload_path='', $detail_view=FALSE, $draw_table_tags=TRUE, $extra='')
    {
        ...
        if($this->fields[$tf_control_name]['allow_html_tags'] == TRUE)
        {
            $value = $$tf_control_name;
        }
        else
        ...
        if($detail_view==FALSE)
        {
            ...
            echo '<input type="file" name="' . $tf_control_name . '" ' . $extra . '>';
    ...
    function draw_select_field($options, $cobalt_field_label, $form_control_name='', $draw_table_tags=TRUE, $extra='')
    {
        ...
        echo "<select name='$form_control_name' $extra>\r\n";
    ...
    function draw_select_field_mf($param, $cntr)
    {
        ...
        if($detail_view != TRUE)
        {
            echo "<select name='$form_control_name" . "[$cntr]' $extra> \r\n";
...
*/
    ...
    function draw_text_field($cobalt_field_label, $tf_control_name='', $detail_view=FALSE, $control_type='', $draw_table_tags=TRUE, $extra='')
    {
        ...
        if(isset($this->fields[$tf_control_name]) &&
        ...
        if($detail_view==FALSE)
        {
            if($control_type=='textarea') echo "<textarea name='$tf_control_name' $extra>" . $value . "</textarea>\r\n";
    ...
    function draw_text_field_mf($param, $cntr)
    {
        ...
        if($detail_view==FALSE)
        {
            if($control_type=='textarea')
            {
                ...
                echo "<textarea name='$form_control_name" . "[$cntr]' $extra>" . $value . "</textarea>\r\n";
            }
            else
            {
                echo "<input type='$control_type' name='$form_control_name" ."[$cntr]' value='" . $value . "' $extra>\r\n";
            }
        }
        else
        {
    ...
    function draw_multifield_auto($label, $arr_multifield, $num_particulars_var=null, $particulars_count_var=null, $particular_button_var=null)
    {
        ...
        if($this->detail_view==FALSE)
        {
            echo '<br> Change # of items to:
                      ...
                      <input type="submit" name="' . $particular_button_var . '" value="GO">' . "\r\n";
        }
