...
$page_title       = 'ListView: Final Paper Hdr';
$db_subclass      = 'final_paper_hdr';
$html_subclass    = 'final_paper_hdr_html';
$arr_pkey_name    = array('id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add final paper hdr';
$edit_link        = 'Edit final paper hdr';
$delete_link      = 'Delete final paper hdr';
$view_link        = 'View final paper hdr';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_final_paper_hdr.php';
$edit_page        = 'edit_final_paper_hdr.php';
$delete_page      = 'delete_final_paper_hdr.php';
$view_page        = 'detailview_final_paper_hdr.php';
$csv_page         = 'csv_final_paper_hdr.php';
$report_page      = 'reporter_final_paper_hdr.php';
