<?php
define('GLOBAL_PROJECT_NAME', 'FLAVIO 2 - External Relations');
define('GLOBAL_SESSION_NAME', 'Cc8175253');

//Default database settings
define('DEFAULT_DB_HOST','localhost');
define('DEFAULT_DB_USER','root');
define('DEFAULT_DB_PASS','#w3bdev');
define('DEFAULT_DB_USE' ,'FLAVIO_COB');

//Paths and directory names
define('BASE_DIRECTORY', 'flavio2_extrels');
