...
class AgeBracket extends data_abstraction
{
    var $fields = array();
    ...
    function add($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $this->set_fields('Id, StartAge, EndAge');
            $this->set_values("?,?,?");

            $bind_params = array('iii',
                                 &$this->fields['Id']['value'],
                                 &$this->fields['StartAge']['value'],
                                 &$this->fields['EndAge']['value']);
    ...
    function edit($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $this->set_update("StartAge = ?, EndAge = ?");
            $this->set_where("Id = ?");
