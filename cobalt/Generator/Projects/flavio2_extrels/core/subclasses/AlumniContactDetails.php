...
class AlumniContactDetails extends data_abstraction
{
    var $fields = array();

    var $db_use='ACCOM';

    function AlumniContactDetails()
    {
    ...
    function add($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $this->set_fields('Id, AlumniInfoId, ContactType, ContactValue');
            $this->set_values("?,?,?,?");

            $bind_params = array('iiss',
                                 &$this->fields['Id']['value'],
                                 &$this->fields['AlumniInfoId']['value'],
                                 &$this->fields['ContactType']['value'],
                                 &$this->fields['ContactValue']['value']);
    ...
    function edit($param)
    {
        ...
        if($this->stmt_template=='')
        {
            ...
            $this->set_update("AlumniInfoId = ?, ContactType = ?, ContactValue = ?");
            $this->set_where("Id = ?");
