...
if(xsrf_guard())
{
    ...
    if($_POST['btn_load'])
    {
        if(trim($_POST['chosen_report']) != '')
        {
            ...
            $group_field = $_SESSION[$reporter->session_array_name]['group_field'] = unserialize($arr_report_details['group_field']);
    ...
    if($_POST['btn_save'])
    {
        if(trim($_POST['saved_report_title']) != '')
        {
            ...
            if(isset($_POST['group_field']))
            {
                $arr_params['group_field'] = serialize($_POST['group_field']);
            }
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($message == '')
        {
            ...
            {
                $group_field = $_POST['group_field'];
                $_SESSION[$sess_var]['group_field'] = $group_field;
            }
