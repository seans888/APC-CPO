...
//******************************************************************
require 'path.php';
init_cobalt('View PhilRegion');

$page_title       = 'ListView: PhilRegion';
$db_subclass      = 'PhilRegion';
$html_subclass    = 'PhilRegion_html';
$arr_pkey_name    = array('Id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add PhilRegion';
$edit_link        = 'Edit PhilRegion';
$delete_link      = 'Delete PhilRegion';
$view_link        = 'View PhilRegion';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_PhilRegion.php';
$edit_page        = 'edit_PhilRegion.php';
$delete_page      = 'delete_PhilRegion.php';
$view_page        = 'detailview_PhilRegion.php';
$csv_page         = 'csv_PhilRegion.php';
$report_page      = 'reporter_PhilRegion.php';
