...
//******************************************************************
require 'path.php';
init_cobalt('Add InternalSchool');
...
if(xsrf_guard())
{
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($dbh_InternalSchool->check_uniqueness($arr_form_data)->is_unique)
        {
        ...
        if($message=="")
        {
            $dbh_InternalSchool->add($arr_form_data);
...
$html->draw_header('Add InternalSchool', $message, $message_type);
