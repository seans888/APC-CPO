...
//******************************************************************
require 'path.php';
init_cobalt('Edit AlumniEmplRecord');
...
elseif(xsrf_guard())
{
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($dbh_AlumniEmplRecord->check_uniqueness_for_editing($arr_form_data)->is_unique)
        {
        ...
        if($message=="")
        {
            $dbh_AlumniEmplRecord->edit($arr_form_data);
...
$html->draw_header('Edit AlumniEmplRecord', $message, $message_type);
