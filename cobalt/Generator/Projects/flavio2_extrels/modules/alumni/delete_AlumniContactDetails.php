...
//******************************************************************
require 'path.php';
init_cobalt('Delete AlumniContactDetails');

if(isset($_GET['Id']))
{
    $Id = urldecode($_GET['Id']);
    require_once 'form_data_AlumniContactDetails.php';
}
elseif(xsrf_guard())
{
...
$html->draw_header('Delete AlumniContactDetails', $message, $message_type);
