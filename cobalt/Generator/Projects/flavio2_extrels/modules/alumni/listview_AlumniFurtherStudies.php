...
$page_title       = 'ListView: AlumniFurtherStudies';
$db_subclass      = 'AlumniFurtherStudies';
$html_subclass    = 'AlumniFurtherStudies_html';
$arr_pkey_name    = array('Id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add AlumniFurtherStudies';
$edit_link        = 'Edit AlumniFurtherStudies';
$delete_link      = 'Delete AlumniFurtherStudies';
$view_link        = 'View AlumniFurtherStudies';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_AlumniFurtherStudies.php';
$edit_page        = 'edit_AlumniFurtherStudies.php';
$delete_page      = 'delete_AlumniFurtherStudies.php';
$view_page        = 'detailview_AlumniFurtherStudies.php';
$csv_page         = 'csv_AlumniFurtherStudies.php';
$report_page      = 'reporter_AlumniFurtherStudies.php';
