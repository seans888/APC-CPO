...
$page_title       = 'ListView: AlumniProfQualification';
$db_subclass      = 'AlumniProfQualification';
$html_subclass    = 'AlumniProfQualification_html';
$arr_pkey_name    = array('Id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add AlumniProfQualification';
$edit_link        = 'Edit AlumniProfQualification';
$delete_link      = 'Delete AlumniProfQualification';
$view_link        = 'View AlumniProfQualification';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_AlumniProfQualification.php';
$edit_page        = 'edit_AlumniProfQualification.php';
$delete_page      = 'delete_AlumniProfQualification.php';
$view_page        = 'detailview_AlumniProfQualification.php';
$csv_page         = 'csv_AlumniProfQualification.php';
$report_page      = 'reporter_AlumniProfQualification.php';
