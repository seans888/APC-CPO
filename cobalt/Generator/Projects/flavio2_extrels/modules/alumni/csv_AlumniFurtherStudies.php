...
if(xsrf_guard())
{
    ...
    if($_POST['btn_cancel']) 
    {
        ...
        redirect("listview_AlumniFurtherStudies.php");
    }
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($message=="")
        {
            ...
            $csv_name = $token . $_SESSION['user'] . '_AlumniFurtherStudies_' . $timestamp . '.csv';
            $filename = TMP_DIRECTORY . '/' .  $csv_name;

            $csv_contents = $dbh_AlumniFurtherStudies->export_to_csv();
...
$html->draw_header('CSV Exporter: AlumniFurtherStudies', $message, $message_type);
