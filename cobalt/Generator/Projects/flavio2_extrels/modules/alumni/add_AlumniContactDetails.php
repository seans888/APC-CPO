...
//******************************************************************
require 'path.php';
init_cobalt('Add AlumniContactDetails');
...
if(xsrf_guard())
{
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($dbh_AlumniContactDetails->check_uniqueness($arr_form_data)->is_unique)
        {
        ...
        if($message=="")
        {
            $dbh_AlumniContactDetails->add($arr_form_data);
...
$html->draw_header('Add AlumniContactDetails', $message, $message_type);
