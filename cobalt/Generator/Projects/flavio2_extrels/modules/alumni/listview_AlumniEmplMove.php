...
//******************************************************************
require 'path.php';
init_cobalt('View AlumniEmplMove');

$page_title       = 'ListView: AlumniEmplMove';
$db_subclass      = 'AlumniEmplMove';
$html_subclass    = 'AlumniEmplMove_html';
$arr_pkey_name    = array('Id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add AlumniEmplMove';
$edit_link        = 'Edit AlumniEmplMove';
$delete_link      = 'Delete AlumniEmplMove';
$view_link        = 'View AlumniEmplMove';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_AlumniEmplMove.php';
$edit_page        = 'edit_AlumniEmplMove.php';
$delete_page      = 'delete_AlumniEmplMove.php';
$view_page        = 'detailview_AlumniEmplMove.php';
$csv_page         = 'csv_AlumniEmplMove.php';
$report_page      = 'reporter_AlumniEmplMove.php';
