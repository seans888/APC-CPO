...
//******************************************************************
require 'path.php';
init_cobalt('Edit CompanyContact');
...
elseif(xsrf_guard())
{
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($dbh_CompanyContact->check_uniqueness_for_editing($arr_form_data)->is_unique)
        {
        ...
        if($message=="")
        {
            $dbh_CompanyContact->edit($arr_form_data);
...
$html->draw_header('Edit CompanyContact', $message, $message_type);
