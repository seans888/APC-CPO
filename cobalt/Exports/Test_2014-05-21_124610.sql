...
INSERT INTO `table`(Table_ID, Project_ID, DB_Connection_ID, Table_Name, Remarks) VALUES('0eXC8zUL0TQaZopT5YoUWA', 'acXIoSSYQ61P8SYocbEYWA', 'HkD8/3LrYOwHuq4nP15o3A', 'experiments', '');
...
INSERT INTO `table_fields`(Field_ID, Table_ID, Field_Name, Data_Type, Nullable, Length, Attribute, Control_Type, Label, In_Listview) VALUES('FVocQ7ASRc492sfa1mqJCw', '0eXC8zUL0TQaZopT5YoUWA', 'experiment_id', 'integer', 'NO', '11', 'primary key', 'none', 'Experiment ID', 'no');
INSERT INTO `table_fields`(Field_ID, Table_ID, Field_Name, Data_Type, Nullable, Length, Attribute, Control_Type, Label, In_Listview) VALUES('uleiPSRSSX+ZUAIvUsbNyA', '0eXC8zUL0TQaZopT5YoUWA', 'title', 'varchar', 'NO', '255', '', 'textbox', 'Title', 'yes');
INSERT INTO `table_fields`(Field_ID, Table_ID, Field_Name, Data_Type, Nullable, Length, Attribute, Control_Type, Label, In_Listview) VALUES('B5gD5ugJy6dDTXjqncbDZA', '0eXC8zUL0TQaZopT5YoUWA', 'description', 'text', 'NO', '255', '', 'textarea', 'Description', 'yes');
INSERT INTO `table_fields`(Field_ID, Table_ID, Field_Name, Data_Type, Nullable, Length, Attribute, Control_Type, Label, In_Listview) VALUES('pEgG86oqBMcP3/0SXjCPKQ', '0eXC8zUL0TQaZopT5YoUWA', 'preliminary_result', 'varchar', 'NO', '255', 'none', 'upload', 'Preliminary Result', 'yes');
INSERT INTO `table_fields`(Field_ID, Table_ID, Field_Name, Data_Type, Nullable, Length, Attribute, Control_Type, Label, In_Listview) VALUES('oRtsc2rTUXcU/6uI42Lqog', '0eXC8zUL0TQaZopT5YoUWA', 'intermediate_result', 'varchar', 'NO', '255', 'none', 'upload', 'Intermediate Result', 'yes');
INSERT INTO `table_fields`(Field_ID, Table_ID, Field_Name, Data_Type, Nullable, Length, Attribute, Control_Type, Label, In_Listview) VALUES('omYYswgwXM7l/zU694c8vg', '0eXC8zUL0TQaZopT5YoUWA', 'final_result', 'varchar', 'NO', '255', 'none', 'upload', 'Final Result', 'yes');
...
INSERT INTO `table_pages`(Table_ID, Page_ID, Path_Filename) VALUES('0eXC8zUL0TQaZopT5YoUWA', '+nSXSR+3BnhhMmaBfNYLbZW1Klls8lauC+9jhXjFZPg=', 'experiments/add_experiments.php');
INSERT INTO `table_pages`(Table_ID, Page_ID, Path_Filename) VALUES('0eXC8zUL0TQaZopT5YoUWA', '/0CxWVJHlM+Z9jATzhv6vAHQnuZZWS4URCnxcUxceXc=', 'experiments/reporter_result_experiments.php');
INSERT INTO `table_pages`(Table_ID, Page_ID, Path_Filename) VALUES('0eXC8zUL0TQaZopT5YoUWA', 'alOVwAQ+rL1qGsKXzH3ntUOTsz3+58x/CjrGwNCoLZU=', 'experiments/edit_experiments.php');
INSERT INTO `table_pages`(Table_ID, Page_ID, Path_Filename) VALUES('0eXC8zUL0TQaZopT5YoUWA', 'AoJ17xCURhNmjVr+1xWj5Ipr8Jqf461C5RKOc6oCY5s=', 'experiments/detailview_experiments.php');
INSERT INTO `table_pages`(Table_ID, Page_ID, Path_Filename) VALUES('0eXC8zUL0TQaZopT5YoUWA', 'DMOnHB6R/wc6cXt89xU9OUTRxKMYr7mnlvpUZidmV7g=', 'experiments/csv_experiments.php');
INSERT INTO `table_pages`(Table_ID, Page_ID, Path_Filename) VALUES('0eXC8zUL0TQaZopT5YoUWA', 'EAOGEEl9nxgSOWL/Rb5QoOYKSwEPz/eM8wakTQEEk3o=', 'experiments/reporter_pdfresult_experiments.php');
INSERT INTO `table_pages`(Table_ID, Page_ID, Path_Filename) VALUES('0eXC8zUL0TQaZopT5YoUWA', 'Mv+1k7TH5VAPb74N+qvQCfXbqWhlyILNtEvdMQHKIxA=', 'experiments/listview_experiments.php');
INSERT INTO `table_pages`(Table_ID, Page_ID, Path_Filename) VALUES('0eXC8zUL0TQaZopT5YoUWA', 'qWMTJddAsNYOu7YBrSc/AV79roA/630phvlC4N6Z7KI=', 'experiments/delete_experiments.php');
INSERT INTO `table_pages`(Table_ID, Page_ID, Path_Filename) VALUES('0eXC8zUL0TQaZopT5YoUWA', 'X0JsxS82n8sIFiKwpQCR9c99doOFEsHIxs4pDGZxg+8=', 'experiments/reporter_experiments.php');
