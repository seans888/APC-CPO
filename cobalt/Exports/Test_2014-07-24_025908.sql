...
INSERT INTO `table_fields`(Field_ID, Table_ID, Field_Name, Data_Type, Nullable, Length, Attribute, Control_Type, Label, In_Listview) VALUES('uLfx0Q9h45qjMrkXpd4fcw', '7VFqczkwneTQLr82H1yZJw', 'preliminary_result', 'varchar', 'NO', '255', '', 'textbox', 'Preliminary Result', 'yes');
INSERT INTO `table_fields`(Field_ID, Table_ID, Field_Name, Data_Type, Nullable, Length, Attribute, Control_Type, Label, In_Listview) VALUES('ytwty9wMUFqPIG3Sn7M7qQ', '7VFqczkwneTQLr82H1yZJw', 'intermediate_result', 'varchar', 'NO', '255', '', 'textbox', 'Intermediate Result', 'yes');
INSERT INTO `table_fields`(Field_ID, Table_ID, Field_Name, Data_Type, Nullable, Length, Attribute, Control_Type, Label, In_Listview) VALUES('qMWsCBIrup4HW43ouBLUrQ', '7VFqczkwneTQLr82H1yZJw', 'final_result', 'varchar', 'NO', '255', '', 'textbox', 'Final Result', 'yes');
