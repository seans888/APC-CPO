...
$page_title       = 'ListView: Attendance';
$db_subclass      = 'attendance';
$html_subclass    = 'attendance_html';
$arr_pkey_name    = array('id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add attendance';
$edit_link        = 'Edit attendance';
$delete_link      = 'Delete attendance';
$view_link        = 'View attendance';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_attendance.php';
$edit_page        = 'edit_attendance.php';
$delete_page      = 'delete_attendance.php';
$view_page        = 'detailview_attendance.php';
$csv_page         = 'csv_attendance.php';
$report_page      = 'reporter_attendance.php';
