...
//******************************************************************
require 'path.php';
init_cobalt('View internship');

$page_title       = 'ListView: Internship';
$db_subclass      = 'internship';
$html_subclass    = 'internship_html';
$arr_pkey_name    = array('id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add internship';
$edit_link        = 'Edit internship';
$delete_link      = 'Delete internship';
$view_link        = 'View internship';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_internship.php';
$edit_page        = 'edit_internship.php';
$delete_page      = 'delete_internship.php';
$view_page        = 'detailview_internship.php';
$csv_page         = 'csv_internship.php';
$report_page      = 'reporter_internship.php';
