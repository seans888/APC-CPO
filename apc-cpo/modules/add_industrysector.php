...
//******************************************************************
require 'path.php';
init_cobalt('Add industrysector');
...
if(xsrf_guard())
{
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($dbh_industrysector->check_uniqueness($arr_form_data)->is_unique)
        {
        ...
        if($message=="")
        {
            $dbh_industrysector->add($arr_form_data);
...
$html->draw_header('Add Industrysector', $message, $message_type);
