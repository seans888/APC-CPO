...
elseif(xsrf_guard())
{
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($dbh_eval_dtl->check_uniqueness_for_editing($arr_form_data)->is_unique)
        {
        ...
        if($message=="")
        {
            $dbh_eval_dtl->edit($arr_form_data);
...
$html->draw_header('Edit Eval Dtl', $message, $message_type);
