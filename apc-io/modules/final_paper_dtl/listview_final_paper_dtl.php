...
$page_title       = 'ListView: Final Paper Dtl';
$db_subclass      = 'final_paper_dtl';
$html_subclass    = 'final_paper_dtl_html';
$arr_pkey_name    = array('id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add final paper dtl';
$edit_link        = 'Edit final paper dtl';
$delete_link      = 'Delete final paper dtl';
$view_link        = 'View final paper dtl';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_final_paper_dtl.php';
$edit_page        = 'edit_final_paper_dtl.php';
$delete_page      = 'delete_final_paper_dtl.php';
$view_page        = 'detailview_final_paper_dtl.php';
$csv_page         = 'csv_final_paper_dtl.php';
$report_page      = 'reporter_final_paper_dtl.php';
