...
//******************************************************************
require 'path.php';
init_cobalt('Add accomplishment');
...
if(xsrf_guard())
{
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($dbh_accomplishment->check_uniqueness($arr_form_data)->is_unique)
        {
        ...
        if($message=="")
        {
            $dbh_accomplishment->add($arr_form_data);
...
$html->draw_header('Add Accomplishment', $message, $message_type);
