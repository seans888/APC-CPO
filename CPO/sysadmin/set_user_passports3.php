...
init_var($Type);
?>
<table width="75%" cellpadding="2" cellspacing="2" class="tableContent">
<tr>
...
<tr>
    ...
    <td>
        ...
        ?>
        <input type="checkbox" id="exclusive" name="exclusive" value="YES" <?php echo $checked; ?>><label for="exclusive"> Exclusive Role
    </td>
</tr>
</table>
