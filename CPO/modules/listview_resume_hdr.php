...
$page_title       = 'ListView: Resume Hdr';
$db_subclass      = 'resume_hdr';
$html_subclass    = 'resume_hdr_html';
$arr_pkey_name    = array('id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add resume hdr';
$edit_link        = 'Edit resume hdr';
$delete_link      = 'Delete resume hdr';
$view_link        = 'View resume hdr';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_resume_hdr.php';
$edit_page        = 'edit_resume_hdr.php';
$delete_page      = 'delete_resume_hdr.php';
$view_page        = 'detailview_resume_hdr.php';
$csv_page         = 'csv_resume_hdr.php';
$report_page      = 'reporter_resume_hdr.php';
